...
Public Class frmpatientsrecords
    ...
    Private Sub dgvpatientrec_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvpatientrec.CellClick
        If e.RowIndex <> -1 Then
            ...
            Patient.txtage.Text = ds.Tables("tblPatients").Rows(e.RowIndex).Item(7).ToString
            Patient.txtweight.Text = ds.Tables("tblPatients").Rows(e.RowIndex).Item(8).ToString
            Patient.txtheight.Text = ds.Tables("tblPatients").Rows(e.RowIndex).Item(9).ToString
            Patient.txtbloodpresure.Text = ds.Tables("tblPatients").Rows(e.RowIndex).Item(10).ToString
            Patient.cbbloodtype.Text = ds.Tables("tblPatients").Rows(e.RowIndex).Item(11).ToString
            Patient.txtsymptoms.Text = ds.Tables("tblPatients").Rows(e.RowIndex).Item(12).ToString
            Patient.txtphonenumber.Text = ds.Tables("tblPatients").Rows(e.RowIndex).Item(13).ToString
            Patient.txtnationality.Text = ds.Tables("tblPatients").Rows(e.RowIndex).Item(14).ToString
            Patient.cbCIVIL.Text = ds.Tables("tblPatients").Rows(e.RowIndex).Item(15).ToString
